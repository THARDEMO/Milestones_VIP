...
export function listingInstance( parentID, instanceData) {
...
function PATCH( entity, instanceData ) {
...
export function DELETE( parentID, ID) {
...
({
    ...
    listener: ( detail ) => {
        ...
        PATCH( detail.entity, detail.data);
    }
})